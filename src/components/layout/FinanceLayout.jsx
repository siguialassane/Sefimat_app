...
const menuItems = [
    ...
    },
    {
        icon: CheckCircle,
        label: "Validations",
        path: "/finance/validations",
    },
    {
        icon: FileSpreadsheet,
        label: "Récapitulatif",
        path: "/finance/recapitulatif",
    },
];
        ...
        <div className="flex h-screen w-full overflow-hidden bg-background-light dark:bg-background-dark">
            ...
            <aside className="hidden lg:flex flex-col w-64 bg-surface-light dark:bg-surface-dark border-r border-border-light dark:border-border-dark">
                ...
                <div className="p-4 border-t border-border-light dark:border-border-dark">
                    <div className="flex items-center gap-3 mb-4">
                        <div className="h-10 w-10 rounded-full bg-amber-500/20 flex items-center justify-center text-amber-600 font-bold text-sm">
            ...
            <main className="flex-1 flex flex-col h-full overflow-hidden">
                ...
                <header className="lg:hidden flex items-center justify-between p-4 bg-surface-light dark:bg-surface-dark border-b border-border-light dark:border-border-dark">
                    ...
                    <div className="flex items-center gap-2">
                        <ThemeToggle />
                        <div className="h-8 w-8 rounded-full bg-amber-500/20 flex items-center justify-center text-amber-600 font-bold text-xs">
                            {userProfile?.nom_complet?.charAt(0) || "F"}
                        </div>
                    </div>
                </header>
